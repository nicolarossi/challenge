...
namespace challenge {
    ...
    class TS_format_exception : public std::exception {
        ...
        public:
            ...
            TS_format_exception(size_t position):position(position) {
    ...
    class TS_format_sync_byte_exception : public TS_format_exception {
        public:
            TS_format_sync_byte_exception(size_t position):TS_format_exception(position){}
    ...
    class TS_format_AFC_value_exception : public TS_format_exception {
        public:
            TS_format_AFC_value_exception(size_t position):TS_format_exception(position){}
